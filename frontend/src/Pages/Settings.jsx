  ...
  const saveSettings = () => {
    if (
      ...
      if (localIpField !== nsSettings.localIp) {
        ...
        getIpNetFromIp(localIpField);
        getIfaceFromIp(localIpField);
      }
      dispatch(setGatewayIp(gatewayIpField));
      dispatch(setGatewayMac(gatewayMacField));
  ...
  return (
    <>
      <div className="p-12 bg-gray-800 select-none" data-tauri-drag-region="">
        ...
        <p className="mt-2 text-gray-400">
          Configure NetCTRL Monitor to your needs. Remember to save changes
          made.
        </p>
