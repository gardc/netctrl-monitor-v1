...
ditto -c -k --keepParent ./build/bin/Monitor.app ./netctrl-monitor-darwin-amd64.zip
echo "Cleaning up"
...
echo "Zipping Package"
ditto -c -k --keepParent ./build/bin/Monitor.app ./netctrl-monitor-darwin-arm64.zip
echo "Cleaning up"
